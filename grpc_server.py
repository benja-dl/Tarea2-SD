...
producer_conf = {
    'bootstrap.servers': 'localhost:9092',  # Cambia kafka1 por localhost
    'client.id': 'grpc-producer'
}
...
class OrderServiceServicer(orders_pb2_grpc.OrderServiceServicer):
    ...
    def CreateOrder(self, request, context):
        ...
        key = str(uuid4())
        producer.produce('pedidos', key=key, value=order_data, callback=delivery_report)
